...
class MyTestCase(unittest.TestCase):
    ...
    def test_init_calendar_check_id_counter(self):
        ...
        self.assertEqual(ev1._id, str(id_counter_before_creating))
        id_counter_before_creating += 1
        self.assertEqual(ev2._id, str(id_counter_before_creating))
        id_counter_before_creating += 1
        self.assertEqual(ev3._id, str(id_counter_before_creating))
    ...
    def test_info_Event(self):
        ...
        ev1 = Event("event1", "event1_descr", "event1_own",
                    ["user1", "user2"], datetime(2007, 12, 6),
                    repeat_type='D', id=1)
        self.assertEqual(ev1.info_Event(), ( '1', "event1", "event1_descr",
